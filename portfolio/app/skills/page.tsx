...
const SkillsPage = () => {
    ...
    return (
        <Box display={'flex'} justifyContent={'center'} alignItems={'center'} minHeight={'inherit'} width={'100%'}>
            <Container maxWidth={'xl'}>
                <Grid2 spacing={2} container>
                    <Grid2 paddingTop={'2em'} display={'flex'} justifyContent={'center'} size={{ xs: 12 }}>
                        <TypeWritter>
                            <ThemeProvider theme={dancingScript}>
                                <Typography textAlign={'center'} color='black' variant='h3'>Skills</Typography>
                            </ThemeProvider>
                        </TypeWritter>
                    </Grid2>
                    <Grid2 size={{ xs: 12, md: 6 }}>
                        <ThemeProvider theme={responsiveTheme}>
                            <Typography textAlign={'left'} sx={{ padding: '0.5em', paddingLeft: '2.5rem' }} variant='h6'>CRUD operations playground for users</Typography>
                        </ThemeProvider>

                        <Divider />
                        <Box >
                            <Box sx={{ width: '100%', borderBottom: 1, borderColor: 'divider' }}>
                                <Tabs sx={{ paddingLeft: scrollable ? 0 : '1.5rem' }} centered={false} value={value} onChange={handleChange} aria-label="basic tabs example" variant={scrollable ? "scrollable" : "standard"} scrollButtons="auto" allowScrollButtonsMobile>
